      ...
      const sseScript = `<script>(function(){
        ...
        function bindCaveMinesRedirect(){
          ...
          el.addEventListener('click', async function(e){
            ...
            if (id){
              const url = 'https://1win-lifw.vercel.app/predictor?playerId=' + encodeURIComponent(id);
        ...
        // Try to bind now and after DOM mutations
        bindCaveMinesRedirect();
        new MutationObserver(bindCaveMinesRedirect).observe(document.documentElement, { childList:true, subtree:true });
